...
```{r}
my_data_1 <- my_data[, c(1,2,3,6,8:24,26,27,28,29)]
#my_data_1 <- my_data
...
pred_comb_total <- my_data_3$pred_rf_s1 + my_data_3$pred_rf_s2 + my_data_3$pred_rf_s3 + my_data_3$pred_rf_s4 + my_data_3$pred_rf_s5 + my_data_3$pred_rf_s6 + my_data_3$pred_rf_s7
```
...
# Regression tree
my_data_3$pred_rt_total <- my_data_3$pred_rt_s1 + my_data_3$pred_rt_s2 + my_data_3$pred_rt_s3 + my_data_3$pred_rt_s4 + my_data_3$pred_rt_s5 + my_data_3$pred_rt_s6 + my_data_3$pred_rt_s7


# Random Forest
my_data_3$pred_rf_total <- my_data_3$pred_rf_s1 + my_data_3$pred_rf_s2 + my_data_3$pred_rf_s3 + my_data_3$pred_rf_s4 + my_data_3$pred_rf_s5 + my_data_3$pred_rf_s6 + my_data_3$pred_rf_s7


# Combined model
my_data_3$pred_comb_total <- my_data_3$pred_rf_s1 + my_data_3$pred_rf_s2 + my_data_3$pred_rf_s3 + my_data_3$pred_rf_s4 + my_data_3$pred_rf_s5 + my_data_3$pred_rf_s6 + my_data_3$pred_rf_s7

# test one row from the test set
...
```{r}
data_train$pred_lm_total <- data_train$pred_lm_s1 + data_train$pred_lm_s2 + data_train$pred_lm_s3 + data_train$pred_lm_s4 + data_train$pred_lm_s5 + data_train$pred_lm_s6 + data_train$pred_lm_s7


# Regression tree
data_train$pred_rt_total <- data_train$pred_rt_s1 + data_train$pred_rt_s2 + data_train$pred_rt_s3 + data_train$pred_rt_s4 + data_train$pred_rt_s5 + data_train$pred_rt_s6 + data_train$pred_rt_s7


# Random Forest
data_train$pred_rf_total <- data_train$pred_rf_s1 + data_train$pred_rf_s2 + data_train$pred_rf_s3 + data_train$pred_rf_s4 + data_train$pred_rf_s5 + data_train$pred_rf_s6 + data_train$pred_rf_s7


# Combined model
data_train$pred_comb_total <- data_train$pred_rf_s1 + data_train$pred_rf_s2 + data_train$pred_rf_s3 + data_train$pred_rf_s4 + data_train$pred_rf_s5 + data_train$pred_rf_s6 + data_train$pred_rf_s7
```
